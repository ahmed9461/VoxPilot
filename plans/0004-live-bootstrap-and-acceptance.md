...
- Local gate: 58 pytest tests, compileall, `bash -n`, and `git diff --check` passed. Commit, CI, controller deployment, and a real owner rental remain; do not claim the live cause or a successful rental from these tests.
